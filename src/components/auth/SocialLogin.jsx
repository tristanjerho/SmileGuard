...
/**
 * Google Social Login Button with Official Google SVG Branding.
 */
export default function SocialLogin({ onGoogleSignIn, isLoading = false, disabled = false }) {
  return (
    <button
      type="button"
    ...
    >
      {isLoading ? (
        <Spinner size="sm" className="text-slate-600 dark:text-slate-300" />
      ) : (
