...
export default function AdminPortal({ adminUser, onLogout }) {
  ...
  return (
    <div className="flex h-screen w-screen bg-[#F8FAFC] dark:bg-slate-950 text-slate-800 dark:text-slate-100 overflow-hidden font-sans transition-colors duration-300">
      ...
      <aside className="w-64 bg-[#0B132B] dark:bg-slate-900 flex flex-col justify-between text-slate-300 shrink-0 shadow-2xl border-r border-slate-800">
        <div>
          {/* Brand Header */}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-8 flex items-center justify-between shadow-sm shrink-0 transition-colors">
          <div className="flex items-center gap-4">
            <h2 className="text-sm font-black text-slate-900 dark:text-white tracking-wide uppercase">
              {activeTab}
            </h2>
